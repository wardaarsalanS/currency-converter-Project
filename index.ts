...
async function convertCurrency() {
    ...
    let userFromCurrency = user_answer.from as keyof CurrencyRates; // using the type assertion as keyof CurrencyRates
    let userToCurrency = user_answer.to  as keyof CurrencyRates; //  This assertion tells TypeScript that you are confident that the values will be valid keys of the CurrencyRates object
